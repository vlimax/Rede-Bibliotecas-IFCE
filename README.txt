...
O conjunto apresenta a relação completa de livros disponíveis para a comunidade acadêmica do Instituto Federal do Ceará (IFCE). O acervo inclui tanto os exemplares físicos (impressos) quanto os recursos digitais (e-books) que compõem as coleções das bibliotecas de todos os campi do IFCE.
